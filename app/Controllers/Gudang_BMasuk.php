...
class Gudang_BMasuk extends Controller
{
   ...
   {
      $data['input'] = $this->db(0)->get_where('master_input', 'tipe = 4 AND cek = 0 ORDER BY id DESC');
      $data['input_done'] = $this->db(0)->get_where('master_input', "tipe = 4 AND cek <> 0 ORDER BY id DESC LIMIT 50");
