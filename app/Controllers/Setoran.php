...
class Setoran extends Controller
{
   ...
   public function content($parse = "")
   {
      ...
      $where = "id_toko = " . $this->userData['id_toko'] . " AND status_mutasi = 1 AND status_setoran <> 0 AND metode_mutasi = 1 AND id_client <> 0 AND ref_setoran <> '' GROUP BY ref_setoran, status_setoran ORDER BY ref_setoran DESC LIMIT 20";
