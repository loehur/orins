...
class Riwayat_Jual extends Controller
{
   ...
   function riwayat_data($date_f = "", $date_t = "")
   {
      ...
      if ($date_f <> "") {
         $data['mutasi'] = $this->db(0)->get_where('master_mutasi', "stat = 1 AND (insertTime BETWEEN '" . $date_f . " 00:00:00' AND  '" . $date_t . " 23:59:59') AND id_sumber = " . $this->userData['id_toko'] . "  AND jenis = 2");
      } else {
         $data['mutasi'] = [];
      }
