...
$where = "id_afiliasi = " . $this->userData['id_toko'] . " AND id_penerima <> 0 AND id_ambil = 0 AND status_order = 1 AND cancel = 0 AND tuntas = 0 GROUP BY id_toko, id_pelanggan, ref";
