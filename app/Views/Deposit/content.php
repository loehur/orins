...
<main>
    <div class="row mx-0 mt-3" style="max-width: 600px;">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            <select class="rounded tize form-select" name="id_pelanggan" required>
                                <option></option>
                        ...
                        <div class="col-auto">
                            <button type="button" class="cek btn btn-primary">Cek</button>
                        </div>
                    </div>
                </div>
            </div>
