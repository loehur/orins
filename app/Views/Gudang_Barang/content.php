                                ...
                                <tr>
                                    ...
                                    if ($a['sp'] == 0) {
                                        ...
                                        for ($i = 0; $i <= 6; $i += 2) {
                                            ...
                                            if ($i == 6) { ?>
                                                <td class="p-0">
                                                    <span class="cell_edit" data-parent="<?= substr($a['code'], 0, $i) ?>" data-col="<?= $no ?>"><?= substr($a['code'], $i, 3) ?></span><br>
                                                </td>
                                            <?php } else { ?>
                                                <td class="p-0">
                                                    <span class="cell_edit" data-parent="<?= substr($a['code'], 0, $i) ?>" data-col="<?= $no ?>"><?= substr($a['code'], $i, 2) ?></span><br>
                                                </td>
                                            <?php } ?>
                                        <?php
                                        }
