                                                        ...
                                                        <?php if ($ada_produksi[$ref] == true) { ?>
                                                            <td>
                                                                <?php if ($this->userData['id_toko'] == $id_toko[$ref]) { ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        &nbsp;<span class="btnReady text-sm fw-bold" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal11" data-cs="<?= $do['id_afiliasi'] == $this->userData['id_toko'] ? $id_user_afiliasi[$ref] : $id_penerima[$ref] ?>" data-ref="<?= $ref ?>"> <small><i class="fa-solid fa-check-double"></i> Ready</small></span>
                                                                    <?php } ?>
                                                                <?php } else { ?>
