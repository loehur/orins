    ...
    <div class="container">
        <div class="row mb-2">
            <div class="col-auto mt-auto px-1 mb-2">
                <a href="<?= PV::BASE_URL ?>Audit_BKeluar"><button class="btn btn-outline pb-0 border-0"><i class="fa-solid fa-chevron-left"></i> <small>Back</small></button></a>
            </div>
...
<script>
    $(".update_bol").on('click', function() {
        ...
        $.ajax({
            url: '<?= PV::BASE_URL ?>Audit_BKeluar/update',
            data: {
                ref: ref
            },
            type: 'POST',
