...
<main class="container">
    ...
    <div class="container px-2">
        <div class="text-sm mb-2">Note: Produk ber-SN tidak dapat dimasukkan kedalam Paket, produk tersebut dapat ditambahkan secara manual saat melakukan orderan</div>
        <div class="row mb-2">
            <div class="col px-0">
            ...
            <div class="col border border-bottom-0 px-0">
                <table class="table table-sm m-0">
                    <?php foreach ($data['order_barang'] as $db) {
                        ...
                        <tr>
                            <td class="text-secondary text-end ps-2"><span data-id="<?= $db['id'] ?>" data-primary="id" data-tb="paket_mutasi" data-ref="<?= $data['ref'] ?>" class="price_key <?= $classKeyPrice ?>" style="cursor: pointer;"><i class="fa-solid fa-key"></i></span> #<?= $db['id'] ?><br><b><?= $db['sds'] == 0 ? "ABF" : "SDS" ?></b></td>
