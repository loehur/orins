    ...
    <div class="container">
        <div class="row mb-2">
            <div class="col-auto mt-auto px-1 mb-2">
                <a href="<?= PV::BASE_URL ?>Retur_Barang_C"><button class="btn btn-outline pb-0 border-0"><i class="fa-solid fa-chevron-left"></i> <small>Back</small></button></a>
            </div>
...
<script>
    ...
    $("#barang").change(function() {
        var get = $(this).val();
        if (get != "") {
            $('#stok_data').load('<?= PV::BASE_URL ?>Retur_Barang_C/stok_data/' + get + '/' + '<?= $d['id'] ?>');
        }
    })
</script>