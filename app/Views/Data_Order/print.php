        ...
        foreach ($data['kas'] as $dk) {
            if ($dk['ref_transaksi'] == $do['ref'] && ($dk['status_mutasi'] == 1 || $dk['status_mutasi'] == 0)) {
                ...
                if ($dk['status_mutasi'] == 0) {
                    $showMutasi .= "<tr><td><small>* " . $payment_account . $note . "</small></td><td><small>" . date('d/m/y H:i', strtotime($dk['insertTime'])) . "</small></td><td align='right'><small>Rp" . number_format($dk['jumlah']) . "</small></td><td><small><b>*Checking</b></small></td></tr>";
                } else {
                    if ($dk['metode_mutasi'] <> 1) {
                        $showMutasi .= "<tr><td><small>* " . $payment_account . $note . "</small></td><td><small>" . date('d/m/y H:i', strtotime($dk['insertTime'])) . "</small></td><td align='right'><small>Rp" . number_format($dk['jumlah']) . "</small></td></tr>";
                    } else {
                        ...
                        $showMutasi .= "<tr><td><small>* " . $payment_account . $note . "</small></td><td><small>" . date('d/m/y H:i', strtotime($dk['insertTime'])) . "</small></td><td align='right'><small>Rp" . number_format($dk['jumlah']) . " " . $pembayaran_cash . "</small></td></tr>";
                    }
                }
            }
        }
